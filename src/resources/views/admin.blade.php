            ...
            <div class="admin__group">
                <form class="form__search" action="/search" method="GET">
                    <div class="form__search-text">
                        <!-- 検索条件を保持 -->
                        <input type="text" name="search" placeholder="名前やメールアドレスを入力してください" class="form-control" value="{{ request('search') }}" />
                    </div>
                    <div class="form__search-select">
                        <select name="gender" class="form__search-select">  <!-- 検索条件を保持 -->
                    ...
                    <div class="form__search-select">
                        <select name="category_id" class="form__search-select">  <!-- 検索条件を保持 -->
                            ...
                            <option value="" {{ request('category_id') === '' ? 'selected' : '' }}>すべて</option>
                        </select>
                    </div>
